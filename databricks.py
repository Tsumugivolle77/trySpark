...
income_groups_max_edu_level = income_groups.max('education_num')
income_groups_min_edu_level = income_groups.min('education_num')
income_groups_max_edu_level.show()
income_groups_min_edu_level.show()
...
print(f'For people who receive the least education\n'
      f'{min_edu_income_g50K}\n'
      f'{min_edu_income_le50K}\n'
      f'For people who receive the most education\n'
      f'{max_edu_income_g50K}\n'
      f'{max_edu_income_le50K}\n')
